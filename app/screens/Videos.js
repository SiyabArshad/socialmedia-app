...
<LoadingModal></LoadingModal>
    ...
    <View style={{padding:RFPercentage(2)}}>
        ...
        <Ionicons name="menu-outline" size={35} color={colors.mblack} />
            ...
            <Text style={{fontSize:RFPercentage(2.5)}}>Videos</Text>
    ...
    >
        {
            ...
            <Text style={{marginTop:RFPercentage(1),color:colors.mblack}}>{item.title&&item.title}</Text>
         ...
         <TouchableOpacity onPress={()=>props.navigation.navigate("Singlevideo",{content:item})}>           
         <Video
        style={{width:"100%",marginVertical:RFPercentage(3),height:RFPercentage(35),borderRadius:RFPercentage(1)}}
        source={{
          uri: item.video,
        }}
        useNativeControls
    ...
    <TouchableOpacity onPress={()=>props.navigation.navigate("Addvideo")}  style={{width:RFPercentage(7),height:RFPercentage(7),borderRadius:RFPercentage(3.5),display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:colors.pink,position:"absolute",top:"80%",right:"5%"}}>

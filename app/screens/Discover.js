    ...
    >
        {
         ...
         <TouchableOpacity style={{display:"flex",alignItems:"center"}} onPress={()=>props.navigation.navigate("PostScreen",{content:item,screenname:"Discover",userid:""})}>           
        <Image  resizeMode= "contain" style={{width:"100%",marginVertical:RFPercentage(3),minHeight:RFPercentage(45)}} source={item.post?{uri:item.post}:require("../../images/nav.png")}></Image>
        </TouchableOpacity>
        </View>
        )
            })
